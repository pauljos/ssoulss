...
<style>
  ...
  .ps-row:nth-of-type(6) .ps-content::before { background: linear-gradient(90deg, #0ea5e9, #0284c7); }
  ...
  .ps-row:nth-of-type(6) .ps-badge { background: #e0f2fe; color: #0284c7; }
  ...
  .ps-visual-soulvault { background: linear-gradient(135deg, #f0f9ff, #e0f2fe); border: 1px solid #bae6fd; }
...
<div class="page-content" style="padding-top:0;">
  ...
  <div class="ps-row reverse">
    <div class="ps-content">
      <span class="ps-badge">Data Exchange</span>
      <h2 class="ps-title">SoulVault</h2>
      <p class="ps-desc">Enterprise-grade secure data exchange platform for modern organisations. AI-powered insights, real-time delivery tracking, and bank-grade security — all in one.</p>
      <div class="ps-tags">
        <span class="ps-tag">256-bit Encryption</span>
        <span class="ps-tag">GDPR Compliant</span>
        <span class="ps-tag">AI-Powered</span>
      </div>
      <div class="ps-actions">
        <a href="/soulvault/" class="ps-btn ps-btn-primary">Learn More →</a>
        <a href="https://soulvault-u246.onrender.com/" target="_blank" class="ps-btn ps-btn-secondary">Open Platform ↗</a>
      </div>
    </div>
    <div class="ps-visual ps-visual-soulvault">
      <div style="text-align:center;padding:20px;width:100%;">
        <svg viewBox="0 0 300 200" fill="none" style="width:100%;max-width:300px;">
          <rect x="30" y="40" width="240" height="36" rx="8" fill="white" stroke="#38bdf8" stroke-width="1.5"/>
          <text x="40" y="62" fill="#0284c7" font-size="8" font-weight="700" font-family="Inter" opacity="0.8">🔐 256-bit Encrypted Vault</text>
          <rect x="30" y="88" width="72" height="28" rx="6" fill="#f0f9ff" stroke="#38bdf8" stroke-width="0.8"/>
          <text x="38" y="106" fill="#0284c7" font-size="8" font-weight="600" font-family="Inter">📄 Docs</text>
          <rect x="114" y="88" width="72" height="28" rx="6" fill="#f0f9ff" stroke="#38bdf8" stroke-width="0.8"/>
          <text x="122" y="106" fill="#0284c7" font-size="8" font-weight="600" font-family="Inter">🤖 AI</text>
          <rect x="198" y="88" width="72" height="28" rx="6" fill="#f0f9ff" stroke="#38bdf8" stroke-width="0.8"/>
          <text x="206" y="106" fill="#0284c7" font-size="8" font-weight="600" font-family="Inter">📊 Insights</text>
          <!-- Stats -->
          <rect x="30" y="130" width="72" height="40" rx="6" fill="white" stroke="#e2e8f0" stroke-width="0.5"/>
          <text x="38" y="146" fill="#64748b" font-size="7" font-weight="600" font-family="Inter">USERS</text>
          <text x="38" y="164" fill="#0ea5e9" font-size="12" font-weight="900" font-family="Inter">10K</text>
          <rect x="114" y="130" width="72" height="40" rx="6" fill="white" stroke="#e2e8f0" stroke-width="0.5"/>
          <text x="122" y="146" fill="#64748b" font-size="7" font-weight="600" font-family="Inter">UPTIME</text>
          <text x="122" y="164" fill="#22c55e" font-size="12" font-weight="900" font-family="Inter">99.9%</text>
          <rect x="198" y="130" width="72" height="40" rx="6" fill="white" stroke="#e2e8f0" stroke-width="0.5"/>
          <text x="206" y="146" fill="#64748b" font-size="7" font-weight="600" font-family="Inter">GDPR</text>
          <text x="206" y="164" fill="#fbbf24" font-size="12" font-weight="900" font-family="Inter">✓</text>
          <rect x="30" y="180" width="240" height="16" rx="4" fill="#f0f9ff"/>
          <text x="40" y="192" fill="#0ea5e9" font-size="8" font-weight="600" font-family="Inter">● All systems secure · 256-bit encryption active</text>
        </svg>
        <div style="margin-top:8px;font-size:13px;font-weight:600;color:#0284c7;">soulvault</div>
      </div>
    </div>
  </div>
